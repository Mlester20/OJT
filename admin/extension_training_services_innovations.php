...
<body>
    ...
    <div class="container mt-4">
        <h3 class="text-center bg-primary text-white p-2">Extension and TRAINING SERVICES INNOVATIONS</h3>
    ...
    <script>
        ...
        function saveInnovations() {
            ...
            $.ajax({
                url: '../controllers/save_extensions_innovationsController.php',
                type: 'POST',
